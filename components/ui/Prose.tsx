  ...
  return (
    <div
      className={cn(
        ...
        // Body text
        "text-body text-mist leading-body",

        // Spacing
        "[&>*+*]:mt-6",

        // Headings
        "[&_h1]:font-display [&_h1]:text-h2 [&_h1]:text-white [&_h1]:font-semibold [&_h1]:tracking-heading [&_h1]:leading-heading [&_h1]:mt-12 [&_h1]:mb-6",
        "[&_h2]:font-display [&_h2]:text-h2 [&_h2]:text-white [&_h2]:font-semibold [&_h2]:tracking-heading [&_h2]:leading-heading [&_h2]:mt-12 [&_h2]:mb-6",
        "[&_h3]:font-display [&_h3]:text-h3 [&_h3]:text-white [&_h3]:font-medium [&_h3]:tracking-heading [&_h3]:leading-heading [&_h3]:mt-10 [&_h3]:mb-4",

        // Body and inline
        "[&_p]:text-body [&_p]:text-mist [&_p]:leading-body [&_p]:max-w-prose",
        ...
        "[&_li]:text-body [&_li]:text-mist [&_li]:leading-body [&_li]:my-2",
        ...
        // Code (rare)
        "[&_code]:font-mono [&_code]:text-caption [&_code]:bg-graphite [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded-sm",
