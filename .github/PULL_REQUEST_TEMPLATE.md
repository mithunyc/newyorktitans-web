...
- [ ] No new dependency was added (or, if added, a `DECISION_LOG.md` entry justifies it)
- [ ] No banned pattern from `AGENTS.md` Section 5 introduced
- [ ] No item from the kill list (NYT pack Section 21) introduced
- [ ] No fake content, placeholder logos, AI-generated people, or stock skylines added
