...
4. communicate mission, values, and community purpose
5. create a beautiful, low-ops, future-ready foundation

If a proposed feature does not materially support one of those five goals, it is out of scope.
...
- depend on constant news publishing to feel credible
- become harder to maintain than the club can realistically support
- use fake metrics or inflated credibility signals
- turn visual ambition into UI clutter
- turn future optionality into present-day complexity
...
- requires weekly content production the team may not sustain
- adds a database without clear necessity
- adds major hosting cost without clear ROI
- exists mainly because “professional teams have it”
- makes the site slower, noisier, or harder to edit
- weakens sponsor clarity or primary CTA focus
...
- academy / youth program pages
- lightweight merchandise experience
- donor campaigns
- email newsletter integration
- public fixtures/results module expansion
- stronger content operations tooling
- image gallery enhancements

Each of these requires a future decision entry in `DECISION_LOG.md` before implementation.
...
4. it does not compromise site clarity or performance
5. it does not create avoidable legal/compliance risk
6. it fits the low-ops philosophy or clearly justifies the added burden
7. it has been approved in `DECISION_LOG.md`
...
- can the club realistically maintain it?

If the answer is not clearly yes, it stays out.
