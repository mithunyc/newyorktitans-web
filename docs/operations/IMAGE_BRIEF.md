...
- not over-compressed
- not cluttered
- usable at mobile and desktop crop ratios
...
- clip-art or decorative cricket graphics as photography substitutes
- screenshots from social posts with UI chrome still visible
- blurry group photos where faces are unreadable
- heavily filtered or oversaturated edits
...
- use transparent PNG or SVG only for logos/graphics
...
4. Does this still work on mobile?
5. Is it better to omit the image than use this one?

If the answer to #5 is yes, omit the image.